RAID = [
    "MADARCHOD TERI MAA KI CHUT ME @do_jism_ek_jaan_op ke admins GHUTKA KHAAKE THOOK DUNGA 🤣🤣",
    "TERE BEHEN K CHUT ME @do_jism_ek_jaan_op ke admins CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    ...
    "@do_jism_ek_jaan_op and @kannada_chatbox ke admins ne choda tumare maa ko behan ko",
...
RRAID = [
    ...
    "@do_jism_ek_jaan_op and @kannada_chatbox ke admins ne choda tumare maa ko behan ko",
    "YE LDNGE BAPP SE",
    "@do_jism_ek_jaan_op and @kannada_chatbox ke admins ne choda tumare maa ko behan koH",
    ...
    "S@do_jism_ek_jaan_op and @kannada_chatbox ke admins ne choda tumare maa ko behan ko",
    ...
    "Kutte ki jat",
    "Kutte ke tatte",
    "T@do_jism_ek_jaan_op and @kannada_chatbox ke admins ne choda tumare maa ko behan ko",
    "Lavde ke bal",
    "muh mei lele",
    "Lund Ke Pasine",
    ...
    "GAANDU",
    "CHUTIYA",
    "T@do_jism_ek_jaan_op and @kannada_chatbox ke admins ne choda tumare maa ko behan koA",
    "SAMJHAA LAWDE",
    ...
    "@do_jism_ek_jaan_op and @kannada_chatbox ke admins ne choda tumare maa ko behan koE",
